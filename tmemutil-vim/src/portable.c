...
WCHAR   portable_data_path[VALUE_LEN+1] SHARED = {0};
#ifdef _MSC_VER
#pragma data_seg()
#endif
...
void CALLBACK init_global_env(void)
{
    ...
    /* 处理portabledata变量 */
    if ( read_appkey(L"Env",L"VimpPentaHome",portable_data_path,sizeof(appdata_path)) )
    {
        wcsncpy(portable_data_path,appdata_path,VALUE_LEN);
    }
